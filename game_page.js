...
function send() 
{
  ...
  replace_charAt1 = word.replace(charAt1, charAt3);
  remove_charAt2 = replace_charAt1.replace(charAt2, charAt1);
  remove_charAt3 = remove_charAt2.replace(charAt3, charAt2);
